...
export function Footer() {
  return (
    <footer className="w-full border-t border-gray-800 bg-black py-8 md:py-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-400">+254 712 345 678</span>
              </li>
              <li className="flex items-center gap-2">
                <svg
                  className="h-4 w-4 text-emerald-500"
                ...
                <span className="text-sm text-gray-400">info@edupathway.com</span>
              </li>
