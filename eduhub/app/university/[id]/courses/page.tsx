...
export default function UniversityCoursesPage() {
  ...
  const handleGetStarted = () => {
    console.log("[UniversityCoursesPage] Get Started clicked, user:", user);
    if (!user) {
      console.log("[UniversityCoursesPage] User not logged in, showing auth modal");
      ...
      console.log("[UniversityCoursesPage] User authenticated and paid, showing FindCourseForm");
    ...
    async function loadData() {
      try {
        ...
        if (!universityCode || typeof universityCode !== "string") {
          console.error("[loadData] Invalid university code:", universityCode);
        ...
        if (!Array.isArray(uniData) || uniData.length === 0) {
          console.error("[loadData] University not found for code:", universityCode);
        ...
        console.log("[loadData] Fetching courses for universityCode:", universityCode);
