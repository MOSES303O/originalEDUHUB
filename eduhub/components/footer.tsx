...
export function Footer() {
  return (
    <footer className="w-full border-t border-gray-800 py-8 md:py-12">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <GraduationCap className="h-6 w-6 text-emerald-500" />
              <span className="text-lg font-bold gradient-text">EduHub</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/university" className="text-sm text-gray-400 hover:text-emerald-400 transition-colors">
                  University
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-400">+254 7 179 094 71</span>
              </li>
              <li className="flex items-center gap-2">
                <svg
                  className="h-4 w-4 text-emerald-500"
                ...
                <span className="text-sm text-gray-400">info@eduhub.com</span>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} EduHub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
