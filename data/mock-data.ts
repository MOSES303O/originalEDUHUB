...
export const mockApiResponse: University[] = [
  {
    id: 2,
...
// Enhanced mock data for universities
    ...
    departments: [
      {
        name: "Computer Science",
        courseCount: 12,
        courses: mockCourses.filter((c) => c.universityId === 2 && c.department === "Computer Science"),
      },
      {
        name: "Engineering",
        courseCount: 18,
        courses: mockCourses.filter((c) => c.universityId === 2 && c.department === "Engineering"),
      },
      {
        name: "Business Studies",
        courseCount: 15,
        courses: mockCourses.filter((c) => c.universityId === 2 && c.department === "Business Studies"),
      },
      {
        name: "Medicine",
        courseCount: 8,
        courses: mockCourses.filter((c) => c.universityId === 2 && c.department === "Medicine"),
      },
      {
        name: "Education",
        courseCount: 22,
        courses: mockCourses.filter((c) => c.universityId === 2 && c.department === "Education"),
      },
    ],
    faculties: [
      {
    ...
    departments: [
      {
        name: "Agriculture",
        courseCount: 14,
        courses: mockCourses.filter((c) => c.universityId === 3 && c.department === "Agriculture"),
      },
      {
        name: "Education",
        courseCount: 18,
        courses: mockCourses.filter((c) => c.universityId === 3 && c.department === "Education"),
      },
      {
        name: "Arts & Social Sciences",
        courseCount: 20,
        courses: mockCourses.filter((c) => c.universityId === 3 && c.department === "Arts & Social Sciences"),
      },
      {
        name: "Science",
        courseCount: 16,
        courses: mockCourses.filter((c) => c.universityId === 3 && c.department === "Science"),
      },
      {
        name: "Business & Economics",
        courseCount: 12,
        courses: mockCourses.filter((c) => c.universityId === 3 && c.department === "Business & Economics"),
      },
    ],
    faculties: [
      {
    ...
    departments: [
      {
        name: "Engineering",
        courseCount: 24,
        courses: mockCourses.filter((c) => c.universityId === 1 && c.department === "Engineering"),
      },
      {
        name: "Computer Science & IT",
        courseCount: 16,
        courses: mockCourses.filter((c) => c.universityId === 1 && c.department === "Computer Science & IT"),
      },
      {
        name: "Agriculture",
        courseCount: 18,
        courses: mockCourses.filter((c) => c.universityId === 1 && c.department === "Agriculture"),
      },
      {
        name: "Education",
        courseCount: 20,
        courses: mockCourses.filter((c) => c.universityId === 1 && c.department === "Education"),
      },
      {
        name: "Business Studies",
        courseCount: 14,
        courses: mockCourses.filter((c) => c.universityId === 1 && c.department === "Business Studies"),
      },
    ],
    faculties: [
      {
...
export function enrichUniversityData(universities: University[]): UniversityWithCourses[] {
  return universities.map((university) => ({
    ...university,
    ...mockEnhancedData[university.id as keyof typeof mockEnhancedData],
  }))
}
